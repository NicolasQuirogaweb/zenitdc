...
import { Users, Wallet, Truck, HardHat, Receipt, Wrench } from 'lucide-react'
      ...
      <div className="mx-auto mt-6 max-w-2xl px-4 pb-8">
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          >
            ...
            <p className="mt-1 text-sm text-[color:var(--color-text-secondary)]">Materiales</p>
          </Link>
          ...
          >
            ...
            <h2 className="mt-3 font-semibold text-[color:var(--color-text-primary)]">Personal</h2>
